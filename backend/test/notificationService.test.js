...
const ids = {
  ...
  challenge: '66c000000000000000000001',
...
const baseNotification = (overrides = {}) => ({
  ...
  message: 'FC KIET challenged your team.',
  entityType: 'challenge',
  entityId: ids.challenge,
  actionUrl: '/team/challenges?tab=received',
  dedupeKey: `challenge:${ids.challenge}:received`,
  isRead: false,
  readAt: null,
